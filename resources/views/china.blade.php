...
<div class="china_bg px-10 lg:px-60 py-10 flex flex-col justify-center items-center lg:px-60 py-10 pt-8" style="position: relative;">
        <h1 class="text-3xl font-bold text-white uppercase delivery py-3 my-8 text-center"><span class="my_bluec font-bold uppercase text-3xl">@lang('autos.new')</span> @lang('autos.from_china')</h1>
        <h3 class="uppercase text-xl text-white font-bold text-center">
        @lang('autos.sub_header')
        </h3>
</div>
    ...
    <div class="flex flex-col lg:flex-row lg:space-x-4 items-start">
        ...
        <aside class="hidden lg:block lg:w-1/4 bg-white p-4 rounded plc-shadow mb-6 lg:mb-0">
            <form action="{{ route('cars.china-filtered') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <input type="submit" class="my_blue p-2 w-full text-white font-bold uppercase rounded hover:border" value="@lang('autos.find')"/>
                </div>

            <div class="mb-4">
                <h2 class="text-xl font-bold mb-4 text-center h_color">@lang('autos.marks')</h2>
                ...
                <div class="mb-4">
                    <h2 class="text-xl font-bold mb-4 text-center h_color">@lang('autos.status')</h2>
                    <div class="space-y-2 flex flex-col">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="status[]" value="in_transit" class="form-checkbox text-blue-500">
                            <span class="ml-2">@lang('autos.in_transit')</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="status[]" value="available" class="form-checkbox text-blue-500">
                            <span class="ml-2">@lang('autos.available')</span>
                        </label>
                    </div>
                </div>
            
                <div class="mb-4">
                    <h2 class="text-xl font-bold mb-4 text-center h_color">@lang('autos.price')</h2>
                ...
                <div class="mb-4">
                    <h2 class="text-xl font-bold mb-4 text-center h_color">@lang('autos.mileage')</h2>
                    <div class="flex justify-between mb-2">
                ...
                <div class="mb-4">
                    <h2 class="text-xl font-bold mb-4 text-center h_color">@lang('autos.color')</h2>
                    <div class="space-y-2 flex flex-col">
                        <label class="inline-flex items-center">
                ...
                <div class="mb-4">
                    <h2 class="text-xl font-bold mb-4 text-center h_color">@lang('autos.engine')</h2>
                    <div class="space-y-2 flex flex-col">
                        <label class="inline-flex items-center">
        ...
        <div class="lg:ml-6 grid grid-cols-1 gap-4">
            @if($cars->isNotEmpty())
                <div class="font-bold" style="color: grey">@lang('autos.results_found', ['count' => $cars->count()])</div>
        
                @foreach($cars as $car)
                    <div class="bg-white rounded p-2 flex flex-col md:flex-row border car-card" data-car-id="{{ $car->vin }}">
                        ...
                        <div class="sm:ml-4 lg:mt-0">
                            ...
                            <div class="mt-2 flex flex-wrap gap-2 justify-between">
                                <a href="{{ route('cars.show', $car->vin) }}">
                                    <button class="my_yellow uppercase py-2 px-16 rounded">
                                        @lang('autos.view_details')
                                    </button>
                                </a>
                                <button class="bg-blue-500 uppercase text-white py-2 px-16 rounded buy_modal">@lang('autos.buy')</button>
                            </div>
                        </div>
                    </div>
                @endforeach
            @else
                <div class="font-bold" style="color: grey">@lang('autos.no_results')</div>
            @endif
        </div>
