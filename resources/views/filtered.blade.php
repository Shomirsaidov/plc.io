    ...
    <div class="flex flex-col lg:flex-row lg:space-x-4 items-start">
        <aside class="hidden lg:block lg:w-1/4 bg-white p-4 rounded plc-shadow mb-6 lg:mb-0">
            <form action="{{ route('cars.filtered') }}" method="POST">
                ...
                <div class="mb-4">
                    <h2 class="text-xl font-bold mb-4 text-center h_color">@lang('autos.price_label')</h2>
        ...
        <div class="lg:ml-6 grid grid-cols-1 gap-4">
            @if($cars->isNotEmpty())
                    ...
                    <div class="bg-white rounded p-2 flex flex-col md:flex-row border car-card" data-car-id="{{ $car->vin }}">
                        ...
                        <div class="sm:ml-4 lg:mt-0">
                            ...
                            <div class="flex items-center p-2">
                                <div class="font-bold me-3 text-sm" style="color: grey">@lang('autos.price')</div>
                ...
                @endforeach
            @else
                <div class="font-bold text-xl" style="color: grey;">@lang('autos.no_results')</div>
            @endif
        </div>
    </div>
</div>
