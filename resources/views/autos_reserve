...
<div class="ukr_bg px-10 lg:px-60 py-10 flex flex-col justify-center items-center lg:px-60 py-10 pt-8" style="position: relative;">
        <h1 class="text-3xl font-bold text-white uppercase delivery py-3 my-8 text-center">@lang('autos.auto_from') <span class="my_bluec font-bold uppercase text-3xl">@lang('autos.us')</span>, @lang('autos.korea') @lang('autos.in_stock') <span class="my_yellowc font-bold uppercase text-3xl">@lang('autos.ukraine')</span></h1>
                    ...
                    <div class="bg-white rounded p-2 flex flex-col md:flex-row border car-card" data-car-id="{{ $car->vin }}">
                        ...
                        <div class="sm:ml-4 lg:mt-0">
                            ...
                            <div class="pb-0 mt-2 flex flex-wrap text-sm">
                                ...
                                <div class="flex items-center p-2 py-2">
                                  <img src="{{ asset('assets/fuel.svg') }}" alt="Fuel Icon" class="mr-1"> {{ $car->oil }}
                                </div>
                                <div class="flex items-center p-2 py-2">
                            ...
                            <div class="flex items-center p-2">
                                <div class="font-bold me-3 text-sm" style="color: grey">@lang('autos.price_label') :</div>
